...
output:
  blogdown::html_page:
    toc: false
    toc_depth: 1
url_code: "https://raw.githubusercontent.com/iecastro/blogdown-site/blob/master/content/post/2020-01-15-env-pb-syr/index.Rmd"
...
```{r, fig.cap='Open lead violations as of 12/18/19. Hover points for street address. Source: data.syr.net'}
map_data <- lead_viol %>% 
...
Unresolved lead violation cases are concentrated in the Southside and Northside sectors of the city, and about half of these cases have been open since 2018 or earlier (some go back as far as 2013).  See this [dashboard for details](iecastro.github.io/syr-lead-viol) on each open case.
...
Data source: [Syracuse Poverty Index](https://github.com/jamisoncrawford/index)
